            ...
            <section id="hero" className="container py-md-3">
                <div className="row py-3 py-md-5">
                    <div className="col-md-6 hero-description d-flex flex-column justify-content-center align-items-centers order-last order-md-first">
                        ...
                        <p>Hello! I am Razu Ahmed Joy. A professional Photographer. Working as a photographer since 2007. I have participated in about 800+ photography events and served more than 1000+ clients with my shutter clicks.</p>
